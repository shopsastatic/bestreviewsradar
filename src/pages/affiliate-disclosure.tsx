...
const Page: FaustPage<GetAffDisPageQuery> = (props: any) => {
    return (
        <PageLayout
...
Page.query = gql(`
  query GetAffDisPage($headerLocation: MenuLocationEnum!, $footerLocation: MenuLocationEnum!, $sidebarLocation: MenuLocationEnum!) {
    generalSettings {
