...
const SingleHeader: FC<SingleHeaderProps> = ({
  ...
  const shareToMail = () => {
    const subject = encodeURIComponent(post?.title || 'Check this out!');
      ...
      <div className='container my-6'>
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 justify-between">
          ...
          <div className="col-span-1 flex justify-start md:justify-end gap-5 md:gap-3 mt-5 md:mt-0">
            <div onClick={shareToX} className="cursor-pointer w-[35px] h-[35px] md:w-[45px] md:h-[45px] bg-white rounded-[8px] border border-[#d0d5dd] flex justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[17px] h-[17px] md:w-[20px] md:h-[20px]" fill="none" viewBox="0 0 20 20"><g clip-path="url(#X_svg__a)" fill="none"><path fill="#98A2B3" fillRule="evenodd" d="m13.288 19.167-4.625-6.591-5.789 6.591H.424l7.153-8.14L.425.834h6.288l4.359 6.213 5.46-6.213h2.45l-6.82 7.764 7.414 10.57zm2.727-1.858h-1.649L3.933 2.692H5.58l4.18 5.853.722 1.016z" clipRule="evenodd" /></g><defs><clipPath id="X_svg__a"><path fill="#fff" d="M0 0h20v20H0z" /></clipPath></defs></svg>
            </div>
            <div onClick={shareToFacebook} className="cursor-pointer w-[35px] h-[35px] md:w-[45px] md:h-[45px] bg-white rounded-[8px] border border-[#d0d5dd] flex justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[17px] h-[17px] md:w-[20px] md:h-[20px]" fill="none" viewBox="0 0 20 20"><g clip-path="url(#Facebook_svg__a)" fill="none"><path fill="#98A2B3" d="M20 10c0-5.523-4.477-10-10-10S0 4.477 0 10c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V10h2.54V7.797c0-2.506 1.492-3.89 3.777-3.89 1.093 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.563V10h2.773l-.443 2.89h-2.33v6.988C16.343 19.129 20 14.991 20 10" /></g><defs><clipPath id="Facebook_svg__a"><path fill="#fff" d="M0 0h20v20H0z" /></clipPath></defs></svg>
            </div>
            <div onClick={shareToMail} className="cursor-pointer w-[35px] h-[35px] md:w-[45px] md:h-[45px] bg-white rounded-[8px] border border-[#d0d5dd] flex justify-center items-center">
