  ...
  return (
    <>
      <div className='container my-6'>
        <h1 className="text-center my-12 font-bold leading-[1.1em]">{title}</h1>
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 justify-between">
          ...
          <div className="col-span-1 flex justify-start md:justify-end gap-5 md:gap-3 mt-5 md:mt-0">
            <div onClick={shareToX} className="hover:bg-slate-200 cursor-pointer w-[35px] h-[35px] md:w-[45px] md:h-[45px] bg-white rounded-[8px] border border-[#d0d5dd] flex justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[17px] h-[17px] md:w-[20px] md:h-[20px]" fill="none" viewBox="0 0 20 20"><g clipPath="url(#X_svg__a)" fill="none"><path fill="#98A2B3" fillRule="evenodd" d="m13.288 19.167-4.625-6.591-5.789 6.591H.424l7.153-8.14L.425.834h6.288l4.359 6.213 5.46-6.213h2.45l-6.82 7.764 7.414 10.57zm2.727-1.858h-1.649L3.933 2.692H5.58l4.18 5.853.722 1.016z" clipRule="evenodd" /></g><defs><clipPath id="X_svg__a"><path fill="#fff" d="M0 0h20v20H0z" /></clipPath></defs></svg>
            </div>
            <div onClick={shareToFacebook} className="hover:bg-slate-200 cursor-pointer w-[35px] h-[35px] md:w-[45px] md:h-[45px] bg-white rounded-[8px] border border-[#d0d5dd] flex justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[17px] h-[17px] md:w-[20px] md:h-[20px]" fill="none" viewBox="0 0 20 20"><g clipPath="url(#Facebook_svg__a)" fill="none"><path fill="#98A2B3" d="M20 10c0-5.523-4.477-10-10-10S0 4.477 0 10c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V10h2.54V7.797c0-2.506 1.492-3.89 3.777-3.89 1.093 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.563V10h2.773l-.443 2.89h-2.33v6.988C16.343 19.129 20 14.991 20 10" /></g><defs><clipPath id="Facebook_svg__a"><path fill="#fff" d="M0 0h20v20H0z" /></clipPath></defs></svg>
            </div>
            <div onClick={shareToMail} className="hover:bg-slate-200 cursor-pointer w-[35px] h-[35px] md:w-[45px] md:h-[45px] bg-white rounded-[8px] border border-[#d0d5dd] flex justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="e-font-icon-svg e-fas-envelope w-[17px] h-[17px] md:w-[20px] md:h-[20px]"><path d="M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z" fill="#98A2B3" /></svg>
            </div>
          </div>
        </div>
      </div>
