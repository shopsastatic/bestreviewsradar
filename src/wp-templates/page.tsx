...
import {
  ...
  Shield, Database, BarChart2, Users, LineChart, Target, CheckCircle, Calendar, BookOpen, Linkedin, Twitter, Mail,
  Eye,
  Smartphone,
  Settings,
  Speaker,
              ...
              <div className="bg-gray-50 rounded-2xl p-5 md:p-8">
                <div className="grid lg:grid-cols-2 gap-12">
                  ...
                  <div className="relative rounded-xl overflow-hidden">
                    <img
                      src="https://img.bestreviewsradar.com/images/v1733064832/research-analytics/research-analytics.jpg?_i=AA"
